...
const schemaStatements: string[] = [
  ...
  `ALTER TABLE users ADD COLUMN IF NOT EXISTS ai_access_enabled boolean DEFAULT false;`,
  `ALTER TABLE users ADD COLUMN IF NOT EXISTS ai_access_expires_at timestamp with time zone;`,
